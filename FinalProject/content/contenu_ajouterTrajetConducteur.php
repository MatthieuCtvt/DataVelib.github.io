...
<div class="jumbotron text-form">
    <h1>Ajouter mon trajet en tant que Conducteur</h1>
...
$ok=FALSE;
if (isset($_POST['trajet']) && !$_POST['trajet']=="" && isset($_POST['horaire']) && !$_POST['horaire']=="" && isset($_POST['nbplaces']) && !$_POST['horaire']==""  ) {
    
    $ok=Trajet::insererTrajet($_POST['trajet'], $_SESSION['login'], "","","","",$date,$_POST['horaire'],$_POST['nbplaces'], $_POST['depart'], $_POST['arrivee'], $_POST['commentaire']);
}
if($ok){
...
<form class="form-horizontal text-form" role="form" method='POST' action='index.php?page=ajouterTrajetConducteur'>
    ...
    <div class="form-group">
        <label for="input_date" class="col-sm-4 control-label formulaire">Date du trajet <em>*</em></label>
        <div class="col-sm-4">
    ...
    <div class="form-group">
        <label for="input_horaire" class="col-sm-4 control-label">Heure de départ <em>*</em></label>
        <div class="col-sm-4">
    ...
    <div class="form-group">
        <label for="input_nbplaces" class="col-sm-4 control-label">Nombre de places disponible<em>*</em></label>
        <div class="col-sm-4">
            <input type="text" name="nbplaces" class="form-control" id="input_nom" placeholder="Uniquement si vous êtes conducteur" value='$nbplaces' required="" >
        </div>
    </div>
        
    <div class="form-group">
        <label for="input_depart" class="col-sm-4 control-label">Lieu de départ</label>
        <div class="col-sm-4">
            <input type="text" name="depart" class="form-control" id="input_depart" placeholder="Lieu de départ" value='$depart'>
        </div>
    </div>
        
    <div class="form-group">
        <label for="input_arrivee" class="col-sm-4 control-label">Lieu d'arrivée</label>
        <div class="col-sm-4">
            <input type="text" name="arrivee" class="form-control" id="input_arrivee" placeholder="Lieu d'arrivée" value='$depart'>
        </div>
    </div>
